...
Quebic is a framework for writing serverless functions to run on Kubernetes. Quebic supports for Python, Java and NodeJS programming models to write functions.
