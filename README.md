...
Quebic is a framework for writing serverless functions to run on Kubernetes. You can write your functions in any language. Currently Quebic supports for Python, Java and NodeJS programming models.
